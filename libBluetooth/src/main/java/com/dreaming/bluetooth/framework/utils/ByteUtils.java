...
public class ByteUtils {
    ...
    public static int fitByte(int value){
    ...
    public static int parseInt1(byte[] bytes){
        return bytes[0];
    }

    public static int parseInt2(byte[] bytes){
        return bytes[0]<<8 & bytes[1];
    }

    public static int parseInt3(byte[] bytes){
        return bytes[0]<<16 & bytes[1]<<8 & bytes[2];
    }

    public static int parseInt4(byte[] bytes){
        return bytes[0]<<24 & bytes[1]<<16 & bytes[2]<<8 & bytes[3];
    }

    public static byte[]parseByte1(int value){
        return new byte[]{(byte) value};
    }

    public static byte[]parseByte2(int value){
        return new byte[]{(byte) (value>>8), (byte) value};
    }

    public static byte[] parseByte3(int value){
        return new byte[]{(byte) (value>>16),(byte) (value>>8), (byte) value};
    }

    public static byte[]parseByte4(int value){
