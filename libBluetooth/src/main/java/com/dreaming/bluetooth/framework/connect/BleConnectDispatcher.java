...
import com.dreaming.bluetooth.framework.connect.request.BleConnectRequest;
import com.dreaming.bluetooth.framework.connect.request.BleIndicateRequest;
import com.dreaming.bluetooth.framework.connect.request.BleMtuRequest;
import com.dreaming.bluetooth.framework.connect.request.BleNotifyRequest;
import com.dreaming.bluetooth.framework.connect.request.BleReadDescriptorRequest;
import com.dreaming.bluetooth.framework.connect.request.BleReadRequest;
import com.dreaming.bluetooth.framework.connect.request.BleReadRssiRequest;
import com.dreaming.bluetooth.framework.connect.request.BleRefreshCacheRequest;
import com.dreaming.bluetooth.framework.connect.request.BleRequest;
import com.dreaming.bluetooth.framework.connect.request.BleUnnotifyRequest;
import com.dreaming.bluetooth.framework.connect.request.BleWriteDescriptorRequest;
import com.dreaming.bluetooth.framework.connect.request.BleWriteNoRspRequest;
import com.dreaming.bluetooth.framework.connect.request.BleWriteRequest;
...
public class BleConnectDispatcher implements IBleConnectDispatcher, RuntimeChecker, Handler.Callback {
    ...
    private static BluetoothLogger logger = new BluetoothLogger(BleConnectDispatcher.class);
    ...
    private BleConnectDispatcher(final String mac) {
        mAddress = mac;
    ...
    public void clearRequest(int clearType) {
        ...
        logger.w("clearRequest %d", clearType);
    ...
    private void addNewRequest(BleRequest request) {
        ...
        if (mBleWorkList.size() < MAX_REQUEST_COUNT) {
            ...
            request.onResponse(BluetoothApiResponseCode.Overflow.code);
        }
